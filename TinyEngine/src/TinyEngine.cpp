...
bool TinyEngine::createInstance()
{
	...
	{
		Logger::print(TE_INFO, __FILE__, __LINE__, "Instance layer '%s'", instanceLayerName);
	}
	for (const char* instanceExtensionNames : enabledInstanceExtensionNames)
	{
		Logger::print(TE_INFO, __FILE__, __LINE__, "Instance extension '%s'", instanceExtensionNames);
	}
	...
	Logger::print(TE_INFO, __FILE__, __LINE__, "Created VkInstance with version %u.%u.%u", major, minor, patch);
...
bool TinyEngine::createDevice()
{
	...
	{
		Logger::print(TE_INFO, __FILE__, __LINE__, "Device extension '%s'", deviceExtensionName);
	}
	...
	Logger::print(TE_INFO, __FILE__, __LINE__, "Created VkDevice");
